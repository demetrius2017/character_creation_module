# Тестовая игра с использованием функций

from random import randint
from graphic_arts.start_game_banner import run_screensaver


# с учётом парадигмы ООП — объявите родительский класс Character и 
# дочерние классы Warrior, Mage и Healer. Вместо тела классов 
# используйте эллипсис. Далее перенесите код в поле сниппета, 
